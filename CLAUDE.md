...
- When relabeling old engine "v2.x" narrative for users, present it as upstream lineage/history — **never as a current RustyNES release version.** The current *tagged* release is **v1.3.0 "Bedrock"** (built on the v1.0.0 production core; v1.2.0 "Curator" + v1.1.0 "Scriptable" preceded it; see the top summary).
