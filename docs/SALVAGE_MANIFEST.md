...
| 20 files from session `0b2858a5` scratch | `salvaged/scripts/s-0b2858a5/` | v2.6.20/21 one-offs: `prog53.py`, `program54.py`, `resync.py`, `to_tabs.py`, `mutate.py`, `frozen.asm`, `mis.asm`, the `t_{brack,plain,who}.sh` `pgrep -f` self-match probes, `trp{,2}.sh`, `ci-steps.sh`, `datecheck.sh`, `batch{1,2}.sh`. |
