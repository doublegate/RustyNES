...
Downloaded 6 PPU test ROMs to `/tests/roms/extra/ppu/`:
...
- **`tests/roms/extra/ppu/README.md`**: Complete guide with:
...
- [tests/roms/extra/ppu/README.md](tests/roms/ppu/README.md)
...
- [x] Downloaded PPU test ROMs to `tests/roms/extra/ppu/`
