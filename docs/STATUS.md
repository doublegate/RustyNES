...
> **Current release: v2.1.5 "Fathom" ("Vernier")** (2026-07-11) — the current head of
> the **"Fathom"** accuracy line on the v2.0.0 "Timebase" core, and the **regression-net &
> residual** step that opens the **v2.1.5 → v2.2.0 "deepen the existing project"** run (the
> joint iOS App Store / Google Play launch is deferred to v2.3.0). Five workstreams across
...
> **v2.1.5 "Vernier"** the regression-net & residual step (**the current release**).
...
> a real TURN NAT-traversal retransmit production fix — all NTSC-byte-identical), and
> **v2.1.6 "Expansion Audio" is now in progress**. The **JOINT mobile store launch** (Google Play + Apple App
