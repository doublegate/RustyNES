...
- The two rung-5 caveats — the v-copy delay depth, and promoting the per-cycle AccuracyCoin bus diff to a standing gate — are carried rather than silently dropped.
