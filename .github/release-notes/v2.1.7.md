...
- **[ADR 0033](https://github.com/doublegate/RustyNES/blob/main/docs/adr/0033-cpu-2a03-revision-dma-frontier.md)** records this honestly (in the ADR 0002 tradition): what was modeled + verified, and the exact mechanism-level residual that no public oracle can distinguish. Not solved, not faked — documented, with the config surfaced for a future observable case.
