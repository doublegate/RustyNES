...
**Current release: v1.10.0 "Arcade"** (2026-07-01, the native Libretro / RetroArch core + the egui-0.35 dependency refresh; preceded by v1.9.9 "Workshop", 2026-06-26). RustyNES is now a multi-platform emulation suite, all on the one byte-identical cycle-accurate core — **`docs/STATUS.md` is the authoritative current-state record.** What ships beyond the desktop app:
