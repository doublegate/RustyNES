...
**CONSIDERED AND DEFERRED AT v2.6.19, with a reason that is new.** The ticket
...
a release's subject, not an addition to one. v2.6.19's subject was the DUT
...
**CONSIDERED AND DEFERRED AT v2.6.19, AND THE SIZING RULE THAT CAME OUT OF IT
...
2. **AN RTL CHANGE RE-OPENS THE SEED SWEEP, AND v2.6.19 MEASURED WHAT THAT IS
   ...
   is not: on v2.6.19's RTL **seed 1 stopped closing**, failing setup by twelve
   picoseconds, where v2.6.13's table had recorded that every seed closes. A
   late RTL addition therefore does not merely cost six compiles -- it can
   invalidate the pin the release already chose.
