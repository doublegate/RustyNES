...
> The hardware-verified core and the contribution package are **v3.0.0**, reached
> through [v2.7.x](v2.7.x-core-frontend-audit-plan.md),
> [v2.8.x](v2.8.x-libretro-rtl-audit-plan.md) and
> [v2.9.x](v2.9.x-final-audit-and-hardware-plan.md). This document is kept as
> written, because release notes and ADRs link it; it is no longer a plan.
