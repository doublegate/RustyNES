...
**Project Status:** v2.6.23 "Pulse" released — the access does not increment, it pulses the load already there. **No hardware has run any bitstream.**

---

## Where we are

RustyNES is well past v1.0.0. The current release is **v2.6.23 "Pulse"** — the access does not increment, it pulses the load already there. **No hardware has run any bitstream.**
