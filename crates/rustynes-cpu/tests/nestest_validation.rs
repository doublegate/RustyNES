...
fn nestest_golden_log_validation() {
    ...
    if !rom_path.exists() {
        ...
        eprintln!(
            "To run this test, download nestest.nes from https://github.com/christopherpow/nes-test-roms"
        );
    ...
    if !golden_log_path.exists() {
        ...
        eprintln!(
            "To run this test, download nestest.log from https://github.com/christopherpow/nes-test-roms"
        );
        eprintln!("and place it in the test-roms/cpu/ directory");
        return;
    }
