...
impl App {
    ...
    fn handle_tas_requests(&mut self) {
        ...
        for req in reqs {
            match req {
                // .rnmproj file I/O uses the native file dialog; the browser
                // build has no equivalent yet (parity item for a follow-up), so
                ...
                edit => {
                    ...
                    match edit {
                        ...
                        // Handled above (outside the lock — they open dialogs).
