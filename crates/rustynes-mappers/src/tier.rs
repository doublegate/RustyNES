...
pub const fn mapper_tier(id: u16, _submapper: u8) -> Option<MapperTier> {
    match id {
        ...
        | 179 | 180 | 185 | 189 | 200 | 201 | 202 | 203 | 205 | 209 | 211 | 212 | 213 | 214
        | 218 | 225 | 226 | 227 | 229 | 231 | 233 | 234 | 238 | 242 | 244 | 245 | 246 | 250
        | 253 | 261 | 268 | 286 | 289 | 290 | 301 | 303 | 305 | 306 | 312 | 320 | 336 | 348
        | 349 | 366 | 513 => Some(MapperTier::BestEffort),
...
mod tests {
    ...
    /// multicarts 261/289/320/336/349).
    const BEST_EFFORT_IDS: &[u16] = &[
        ...
        177, 178, 179, 180, 185, 189, 200, 201, 202, 203, 205, 209, 211, 212, 213, 214, 218, 225,
        226, 227, 229, 231, 233, 234, 238, 242, 244, 245, 246, 250, 253, 261, 268, 286, 289, 290,
