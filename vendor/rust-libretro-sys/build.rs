...
fn libretro_h() -> bindgen::Builder {
    ...
    bindgen::Builder::default()
        ...
        // RustyNES patch (see VENDORED.md): bindgen emits `retro_game_info`
        // as the opaque `{ _address: u8 }`, so `retro_load_game` handed cores
        // one meaningless byte. It is defined by hand in `src/lib.rs` instead.
        .blocklist_type("retro_game_info")
