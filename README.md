...
0 failed, 0 skipped** (the figures rung 5 closed on, at v2.6.5 and v2.6.8; the
catalog is 149 rows and the ladder 148 gates as of v2.6.16). The console compiles to a Cyclone V bitstream with timing
