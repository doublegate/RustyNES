...
| MiSTer commercial rendering | six titles, one per supported board, each **byte-identical** to this emulator over all 61,440 pixels — [the montage](https://github.com/doublegate/RustyNES_MiSTer#what-it-renders) |
