...
[![Version](https://img.shields.io/badge/version-v1.7.1-blue.svg)](https://github.com/doublegate/RustyNES/releases)
...
The current release is **v1.7.1**, a bugfix / polish patch on **v1.7.0 "Forge"** (the
writable + programmable tooling, accuracy, mapper-breadth, and reach release on the
cycle-accurate v1.0.0 production core, which follows the v1.6.0 "Studio" TAS-authoring line
and the v1.5.0 "Lens" insight/scriptability line). The road so far:
